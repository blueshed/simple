...
- [Server](template/.claude/docs/server.md) — WebSocket protocol, fan-out, guards
- [Client](template/.claude/docs/client.md) — session, signals, doc subscriptions, merging
- [Database](template/.claude/docs/database.md) — SQL conventions, notify payload, save/remove pattern
