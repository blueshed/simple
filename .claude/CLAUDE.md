...
Use the `/implement` skill when you have a `spec.md` (generated by the modeling tool). It reads the spec and builds the full app: schema, doc functions, mutations, components.
